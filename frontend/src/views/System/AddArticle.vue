...
<script setup> 
  ...
  import { createArticleApi, articletitleImgUploadApi } from "@/api/modules/article";
  ...
  const onSubmit = (formEl) => {
    ...
    formEl.validate((valid) => {
      if (valid) {
        createArticleApi({title: searchInfo.title, content: valueHtml.value, titleImg: searchInfo.titleImg,
