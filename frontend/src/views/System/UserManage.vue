  ...
  <div class="user-manage">
    <ZyTable
      ...
      <template v-slot:avatar="slotProps">
        <el-avatar
          :size="40"
          :src="slotProps.item.avatar || require('@/assets/nophoto.png')"
              ...
              if (res.code == 0) {
                ...
                if (state.userForm.userId === store.state.user.userId) {
                  ...
                  if (state.userForm.roleId !== store.state.user.roleId) {
                    getRoleAuthorityApi({ roleId: state.userForm.roleId }).then(
                      (ret: any) => {
                        if (ret.code === "0000000") {
                          let arr = [];
                  ...
                  store.commit("SET_CLASSID", state.userForm.classId);
